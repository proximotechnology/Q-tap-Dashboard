    ...
    return (
        <Box sx={{ position: 'fixed', left: 0, top: 0, height: '100vh', overflowY: 'auto', zIndex: 1201, bgcolor: "white", width: '100px' }}>
            <Box sx={{ textAlign: "center", alignItems: "center", justifyContent: "center", padding: "20px" }}>
                <IconButton sx={{
                    backgroundColor: "#E57C00", width: "40px", height: "40px",
                    "&:hover": {
            ...
            <List sx={{ padding: "10px 12px" }}>
                {menuItems.map((item, index) => {
                    ...
                    const backgroundColor = isActive && item.text !== "Popular" ? "#E57C00" : item.bgcolor;
                    const backgroundIcon = isActive && item.text !== "Popular" ? "white" : "";
                    const textColor = isActive && item.text !== "Popular" ? "white" : "#E57C00";
