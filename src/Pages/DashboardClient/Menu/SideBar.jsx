...
const SideBar = ({ setFilteredItems }) => {
    ...
    return (
        <> {/* TODO: style the button */}
            <Button sx={{ position: 'absolute', display: { sm: 'none', xs: isOpen ? 'none' : 'block', zIndex: 1201, }, top: '30px' }} onClick={handleOpenSideBar}><Menu /></Button>
            <Box sx={{ position: { xs: isOpen ? 'fixed' : 'none', sm: 'fixed' }, start: 0, top: 0, height: '100vh', overflowY: 'auto', zIndex: 1201, bgcolor: "white", width: '100px' }}>
                <Button sx={{ zIndex: 1201, display: { sm: 'none', xs: 'block' }, alignItems: 'center' ,marginX:'auto'}} onClick={handleOpenSideBar}><Close /></Button>
                ...
                <List sx={{ padding: "10px 12px" }}>
                    {menuItems.map((item, index) => {
                        ...
                        const backgroundColor = isActive && item.text !== "Popular" ? theme.palette.orangePrimary.main : item.bgcolor;
                        const backgroundIcon = isActive && item.text !== "Popular" ? "white" : "";
                        const textColor = isActive && item.text !== "Popular" ? "white" : theme.palette.orangePrimary.main;
