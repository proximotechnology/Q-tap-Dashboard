  ...
  useEffect(() => {
    ...
    if (selectedBranch) {
      ...
      if (branch) {
        ...
        setLang(branch.language || '');
        setTableNumber(branch.tables_number || '');
            ...
            <Grid item xs={12} sm={12} md={3} lg={3} justifyContent="center" alignItems="center">
              ...
              <FormControl variant="outlined" sx={{ width: '100%', marginBottom: '10px' }}>
                ...
                >
                  ...
                  <MenuItem value="2" sx={{ fontSize: '12px', color: 'gray' }}>
                    2
                  </MenuItem>
              ...
              <FormControl variant="outlined" sx={{ width: '100%', marginBottom: '10px' }}>
                ...
                >
                  ...
                  <MenuItem value="4" sx={{ fontSize: '12px', color: 'gray' }}>
                    4
                  </MenuItem>
                  <MenuItem value="5" sx={{ fontSize: '12px', color: 'gray' }}>
                    5
                  </MenuItem>
                </Select>
              </FormControl>
