...
export const Row1 = () => {
    ...
    return (
        <Paper sx={{ height: "250px", borderRadius: "20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <Grid width={"80%"} >
            ...
            <Grid width={"20%"}>
                ...
                >
                    ...
                    <Typography variant="h6"
                        sx={{ color: '#575756', marginTop: '8px', border: "2px solid #ef7d00", padding: "2px 25px", borderRadius: "30px" }}>
                        501,420
                    </Typography>

                    <Grid container spacing={0} justifyContent="center" sx={{ marginTop: '10px', }} >
                        <Button
                            sx={{
                            ...
                            <span class="icon-Paymob" style={{ fontSize: "70px", fill: "white !important" }}></span>
                        </Button>
                    </Grid>
